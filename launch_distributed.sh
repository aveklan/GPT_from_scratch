...
if [ "$MODE" = "pipeline" ]; then
    ...
    export PIPELINE_STAGES=${PIPELINE_STAGES:-$WORLD_SIZE}
    export PIPELINE_HEALTH_LOG=${PIPELINE_HEALTH_LOG:-1}
    export PIPELINE_HEALTH_EVERY=${PIPELINE_HEALTH_EVERY:-5}
    echo "PIPELINE_PARALLEL: $PIPELINE_PARALLEL"
    echo "PIPELINE_STAGES: $PIPELINE_STAGES"
    echo "PIPELINE_HEALTH_LOG: $PIPELINE_HEALTH_LOG"
    echo "PIPELINE_HEALTH_EVERY: $PIPELINE_HEALTH_EVERY"
else
